...
This is a limitation of the native WebKit APIs.""",
  ...
  }) => _PlatformInAppBrowserPropertySupported.isPropertySupported(
    property,
    platform: platform,
  );
  ...
  bool isMethodSupported(
    ...
    TargetPlatform? platform,
  }) => _PlatformInAppBrowserMethodSupported.isMethodSupported(
    method,
    platform: platform,
  );
...
In that case, after the `window.addEventListener("flutterInAppWebViewNsgFixPlatformReady")` event is dispatched, the ajax requests can be intercept for sure.""",
      ),
      IOSPlatform(),
      MacOSPlatform(),
    ],
