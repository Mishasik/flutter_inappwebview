...
public class WebMessageChannel: FlutterMethodCallDelegate {
    static var METHOD_CHANNEL_NAME_PREFIX = "dev.futbolista.nsg_fix/flutter_inappwebview_web_message_channel_"
    var id: String
    ...
    public init(plugin: InAppWebViewNsgFixFlutterPlugin, id: String) {
        self.id = id
        self.plugin = plugin
        super.init()
