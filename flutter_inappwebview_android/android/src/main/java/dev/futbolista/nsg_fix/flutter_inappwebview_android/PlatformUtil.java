...
public class PlatformUtil extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "dev.futbolista.nsg_fix/flutter_inappwebview_platformutil";
  
  @Nullable
  public InAppWebViewNsgFixFlutterPlugin plugin;

  public PlatformUtil(final InAppWebViewNsgFixFlutterPlugin plugin) {
