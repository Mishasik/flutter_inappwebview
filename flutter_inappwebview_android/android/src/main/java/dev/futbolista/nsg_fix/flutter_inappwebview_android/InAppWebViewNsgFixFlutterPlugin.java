package dev.futbolista.nsg_fix.flutter_inappwebview_android;
...
import dev.futbolista.nsg_fix.flutter_inappwebview_android.chrome_custom_tabs.ChromeSafariBrowserManager;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.chrome_custom_tabs.NoHistoryCustomTabsActivityCallbacks;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.credential_database.CredentialDatabaseHandler;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.headless_in_app_webview.HeadlessInAppWebViewManager;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.in_app_browser.InAppBrowserManager;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.print_job.PrintJobManager;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.process_global_config.ProcessGlobalConfigManager;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.proxy.ProxyManager;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.service_worker.ServiceWorkerManager;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.tracing.TracingControllerManager;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.webview.FlutterWebViewFactory;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.webview.InAppWebViewManager;
...
public class InAppWebViewNsgFixFlutterPlugin implements FlutterPlugin, ActivityAware {
  ...
  public InAppWebViewNsgFixFlutterPlugin() {}
