...
public class HeadlessInAppWebViewManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "dev.futbolista.nsg_fix/flutter_headless_inappwebview";
  
  public final Map<String, HeadlessInAppWebView> webViews = new HashMap<>();
  @Nullable
  public InAppWebViewNsgFixFlutterPlugin plugin;

  public HeadlessInAppWebViewManager(final InAppWebViewNsgFixFlutterPlugin plugin) {
