...
public class WebViewFeatureManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "dev.futbolista.nsg_fix/flutter_inappwebview_webviewfeature";

  @Nullable
  public InAppWebViewNsgFixFlutterPlugin plugin;

  public WebViewFeatureManager(@NonNull final InAppWebViewNsgFixFlutterPlugin plugin) {
