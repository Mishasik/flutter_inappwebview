package dev.futbolista.nsg_fix.flutter_inappwebview_android.headless_in_app_webview;
...
import dev.futbolista.nsg_fix.flutter_inappwebview_android.types.Size2D;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.webview.in_app_webview.FlutterWebView;
...
public class HeadlessInAppWebView implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "dev.futbolista.nsg_fix/flutter_headless_inappwebview_";
  ...
  public HeadlessInAppWebView(@NonNull final InAppWebViewNsgFixFlutterPlugin plugin, @NonNull String id, @NonNull FlutterWebView flutterWebView) {
    this.id = id;
    this.plugin = plugin;
