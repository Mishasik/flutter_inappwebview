package dev.futbolista.nsg_fix.flutter_inappwebview_android.pull_to_refresh;
...
public class PullToRefreshLayout extends SwipeRefreshLayout implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "dev.futbolista.nsg_fix/flutter_inappwebview_pull_to_refresh_";
  
  @Nullable
  public PullToRefreshChannelDelegate channelDelegate;
  public PullToRefreshSettings settings = new PullToRefreshSettings();

  public PullToRefreshLayout(@NonNull Context context, @NonNull InAppWebViewNsgFixFlutterPlugin plugin, 
