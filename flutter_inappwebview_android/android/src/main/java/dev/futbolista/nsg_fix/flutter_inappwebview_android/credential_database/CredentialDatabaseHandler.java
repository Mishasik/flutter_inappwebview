package dev.futbolista.nsg_fix.flutter_inappwebview_android.credential_database;
...
public class CredentialDatabaseHandler extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "dev.futbolista.nsg_fix/flutter_inappwebview_credential_database";
  ...
  public CredentialDatabaseHandler(@NonNull final InAppWebViewNsgFixFlutterPlugin plugin) {
    super(new MethodChannel(plugin.messenger, METHOD_CHANNEL_NAME));
    this.plugin = plugin;
  }

  public static void init(@NonNull InAppWebViewNsgFixFlutterPlugin plugin) {
