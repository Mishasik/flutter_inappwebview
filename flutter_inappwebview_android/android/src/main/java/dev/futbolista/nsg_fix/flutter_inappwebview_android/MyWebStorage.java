...
public class MyWebStorage extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "dev.futbolista.nsg_fix/flutter_inappwebview_webstoragemanager";
  ...
  public MyWebStorage(@NonNull final InAppWebViewNsgFixFlutterPlugin plugin) {
