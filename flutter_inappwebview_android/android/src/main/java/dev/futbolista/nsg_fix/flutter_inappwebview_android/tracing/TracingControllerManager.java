package dev.futbolista.nsg_fix.flutter_inappwebview_android.tracing;
...
public class TracingControllerManager implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME = "dev.futbolista.nsg_fix/flutter_inappwebview_tracingcontroller";
  ...
  public TracingControllerManager(final InAppWebViewNsgFixFlutterPlugin plugin) {
    this.plugin = plugin;
