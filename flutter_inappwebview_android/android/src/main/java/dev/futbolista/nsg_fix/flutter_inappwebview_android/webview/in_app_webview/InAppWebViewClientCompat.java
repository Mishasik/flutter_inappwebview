...
import dev.futbolista.nsg_fix.flutter_inappwebview_android.credential_database.CredentialDatabase;
...
import dev.futbolista.nsg_fix.flutter_inappwebview_android.types.URLCredential;
import dev.futbolista.nsg_fix.flutter_inappwebview_android.types.URLProtectionSpace;
...
public class InAppWebViewClientCompat extends WebViewClientCompat {
  ...
  public void onSafeBrowsingHit(@NonNull final WebView view,
    ...
    final WebViewChannelDelegate.SafeBrowsingHitCallback resultCallback = new WebViewChannelDelegate.SafeBrowsingHitCallback() {
      @Override
      public boolean nonNullSuccess(@NonNull dev.futbolista.nsg_fix.flutter_inappwebview_android.types.SafeBrowsingResponse response) {
        Integer action = response.getAction();
        if (action != null) {
      ...
      @Override
      public void defaultBehaviour(@Nullable dev.futbolista.nsg_fix.flutter_inappwebview_android.types.SafeBrowsingResponse result) {
