package dev.futbolista.nsg_fix.flutter_inappwebview_android.types;
...
public class WebViewAssetLoaderExt implements Disposable {
  ...
  @Nullable
  public static WebViewAssetLoaderExt fromMap(@Nullable Map<String, Object> map, @NonNull InAppWebViewNsgFixFlutterPlugin plugin, @NonNull Context context) {
    if (map == null) {
      return null;
    }
  ...
  public static class PathHandlerExt implements WebViewAssetLoader.PathHandler, Disposable {
    ...
    public static final String METHOD_CHANNEL_NAME_PREFIX = "dev.futbolista.nsg_fix/flutter_inappwebview_custompathhandler_";
    ...
    public PathHandlerExt(@NonNull String id, @NonNull InAppWebViewNsgFixFlutterPlugin plugin) {
      this.id = id;
