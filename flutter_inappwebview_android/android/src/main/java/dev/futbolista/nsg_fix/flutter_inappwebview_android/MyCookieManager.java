...
public class MyCookieManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "dev.futbolista.nsg_fix/flutter_inappwebview_cookiemanager";
  @Nullable
  public static CookieManager cookieManager;
  @Nullable
  public InAppWebViewNsgFixFlutterPlugin plugin;

  public MyCookieManager(@NonNull final InAppWebViewNsgFixFlutterPlugin plugin) {
