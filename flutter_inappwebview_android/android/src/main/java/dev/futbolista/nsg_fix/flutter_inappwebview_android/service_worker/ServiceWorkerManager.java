package dev.futbolista.nsg_fix.flutter_inappwebview_android.service_worker;
...
public class ServiceWorkerManager implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME = "dev.futbolista.nsg_fix/flutter_inappwebview_serviceworkercontroller";
  ...
  public ServiceWorkerManager(@NonNull final InAppWebViewNsgFixFlutterPlugin plugin) {
    this.plugin = plugin;
