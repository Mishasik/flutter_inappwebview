...
public interface InAppWebViewInterface {
  ...
  void postWebMessage(dev.futbolista.nsg_fix.flutter_inappwebview_android.types.WebMessage message, Uri targetOrigin, ValueCallback<String> callback) throws Exception;
  ...
  InAppWebViewNsgFixFlutterPlugin getPlugin();
  void setPlugin(InAppWebViewNsgFixFlutterPlugin plugin);
