package dev.futbolista.nsg_fix.flutter_inappwebview_android.webview.web_message;
...
import dev.futbolista.nsg_fix.flutter_inappwebview_android.types.UserScriptInjectionTime;
...
public class WebMessageListener implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "dev.futbolista.nsg_fix/flutter_inappwebview_web_message_listener_";
  ...
  public void initJsInstance() {
    if (webView != null) {
      ...
      webView.getUserContentController().addPluginScript(new PluginScript(
              ...
              null,
              false,
              webView.getCustomSettings().pluginScriptsOriginAllowList,
              webView.getCustomSettings().pluginScriptsForMainFrameOnly
      ));
    }
  }
