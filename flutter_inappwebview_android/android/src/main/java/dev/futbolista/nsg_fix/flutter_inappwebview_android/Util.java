...
public class Util {
  ...
  public static String getUrlAsset(InAppWebViewNsgFixFlutterPlugin plugin, String assetFilePath) throws IOException {
  ...
  public static InputStream getFileAsset(InAppWebViewNsgFixFlutterPlugin plugin, String assetFilePath) throws IOException {
    String key = plugin.flutterAssets.getAssetFilePathByName(assetFilePath);
  ...
  @Nullable
  public static PrivateKeyAndCertificates loadPrivateKeyAndCertificate(@NonNull InAppWebViewNsgFixFlutterPlugin plugin,
