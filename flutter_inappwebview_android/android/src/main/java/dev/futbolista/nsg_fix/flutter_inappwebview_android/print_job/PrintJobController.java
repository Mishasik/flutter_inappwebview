package dev.futbolista.nsg_fix.flutter_inappwebview_android.print_job;
...
import dev.futbolista.nsg_fix.flutter_inappwebview_android.types.PrintJobInfoExt;
...
public class PrintJobController implements Disposable  {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "dev.futbolista.nsg_fix/flutter_inappwebview_printjobcontroller_";
  ...
  public PrintJobController(@NonNull String id, @Nullable PrintJobSettings settings,
                            @NonNull InAppWebViewNsgFixFlutterPlugin plugin) {
    this.id = id;
    this.plugin = plugin;
