...
public class SafariViewController: SFSafariViewController, SFSafariViewControllerDelegate, Disposable {
    static let METHOD_CHANNEL_NAME_PREFIX = "dev.futbolista.nsg_fix/flutter_chromesafaribrowser_"
    ...
    @available(iOS 11.0, *)
    public init(plugin: InAppWebViewNsgFixFlutterPlugin, id: String, url: URL, configuration: SFSafariViewController.Configuration, menuItemList: [[String: Any]] = [], safariSettings: SafariBrowserSettings) {
        self.id = id
        self.plugin = plugin
    ...
    public init(plugin: InAppWebViewNsgFixFlutterPlugin, id: String, url: URL, entersReaderIfAvailable: Bool, menuItemList: [[String: Any]] = [], safariSettings: SafariBrowserSettings) {
        self.id = id
        self.plugin = plugin
        self.menuItemList = menuItemList
        self.safariSettings = safariSettings
