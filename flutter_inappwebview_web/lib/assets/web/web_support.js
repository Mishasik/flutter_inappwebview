...
(function() {
  ...
  window.flutter_inappwebview_nsg_fix_plugin = {
        ...
        prepare: function(settings) {
          ...
          if (iframe != null) {
            ...
            iframe.addEventListener("load", function(event) {
              ...
              try {
                iframe.contentWindow.dispatchEvent(new Event("flutterInAppWebViewNsgFixPlatformReady"));
              } catch (e) {
                console.log(e);
              }
            });
    ...
    nativeCommunication: function(method, viewId, args) {
      try {
        const result = window.flutter_inappwebview_nsg_fix_plugin.nativeSyncCommunication(method, viewId, args);
        return result != null ? JSON.parse(result) : null;
      } catch (e1) {
        try {
          const promise = window.flutter_inappwebview_nsg_fix_plugin.nativeAsyncCommunication(method, viewId, args);
  ...
  let _nativeCommunication = window.flutter_inappwebview_nsg_fix_plugin.nativeCommunication;
})();
